		...
		<div class="page d-flex flex-row flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y px-2 my-5 my-lg-5"
						...
						<div
							...
							<div class="menu-item">
								...
								</span> <span class="menu-title">Chỉnh sửa sản phẩm</span>
								</a>
							</div>
							<div class="menu-item">
								<a class="menu-link" href="/admin/index"> <span
									class="menu-icon"> <span class="svg-icon svg-icon-2">
											<svg xmlns="http://www.w3.org/2000/svg" width="24"
												height="24" viewBox="0 0 24 24" fill="none">
													<path
								...
								</span> <span class="menu-title">Chỉnh sửa người dùng</span>
								</a>
							</div>
						</div>
					</div>
			...
			<div class="wrapper d-flex flex-column flex-row-fluid"
				...
				<div id="kt_header" style="" class="header align-items-stretch">
					<div class="header-brand" style="background-color: white;">
						<a href="/"> <img alt="Logo" src="/assets/img/logo1.svg"
					...
					<div class="toolbar">
						<div
							...
							<div class="page-title d-flex flex-column me-5">
								<h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Thêm
									user</h1>
								<ul
									class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
									<li class="breadcrumb-item text-muted"><a
										href="/admin/product" class="text-muted text-hover-primary">Vai
											trò: Admin</a></li>
				...
				<div class="container w-100">
					<div class="mt-5">
						...
						<form action="/admin/index" method="get">
							<input type="text" data-kt-user-table-filter="search" name="name"
								value="${name}"
						...
						<form:form action="/admin/create" method="post"
							...
							<div class="mb-3">
								<input class="form-check-input" type="checkbox"
									id="adminCheckbox" name="admin"
									${userEdit.admin ? 'checked' : ''}> <label
									class="form-check-label" for="adminCheckbox">Admin</label> <input
									class="form-check-input" type="checkbox" id="userCheckbox"
									name="user" ${!userEdit.admin ? 'checked' : ''}> <label
									class="form-check-label" for="userCheckbox">User</label>
							</div>
							<div>
								<div class="float-end">
									<button formaction="/admin/create" type="submit"
										class="btn btn-primary">Create</button>
									<button formaction="/admin/update" type="submit"
										class="btn btn-secondary">Update</button>
									<button formaction="/admin/delete" type="submit"
										class="btn btn-danger">Delete</button>
									<a href="/admin/index" class="btn btn-warning">Reset</a>
								</div>
							</div>
						</form:form>
					</div>
