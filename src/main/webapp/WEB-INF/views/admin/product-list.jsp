...
<body>
					...
					<div class="toolbar">
						<div
							...
							<div class="page-title d-flex flex-column me-5">
								<h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Quản
									lý</h1>
								<ul
											...
											<c:forEach items="${productList}" var="p">
												<tr>
													...
													<td class="text-end"><a href="#"
														...
														onclick="editProduct('${p.id}+${p.name}+${p.price}+${p.quantity}+${p.createDate}+${!p.isDelete}+${p.category.id}')"
														class="btn btn-warning btn-active-light-primary btn-sm p-1">
															<i class="p-0 bi bi-pencil-square"></i>
													</a> <a href="/admin/product/delete/${p.id}"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form:form action="/admin/product/edit" method="post"
						...
						<div class="mb-3">
							<label for="exampleInputEmail1" class="form-label">ID <span
								class="form-text text-danger">*</span></label>
							<form:input id="id" path="id" readonly="true" type="number"
						...
						<div class="mb-3">
							<label for="exampleInputEmail1" class="form-label">Create
								Date <span class="form-text text-danger">*</span>
							</label>
							<form:input id="createDate" path="createDate" type="text"
						...
						<div class="mb-3">
							<label for="exampleInputEmail1" class="form-label">Category
								<span class="form-text text-danger">*</span>
							</label> <select id="category" name="categoryId" class="form-control">
	...
	<script type="text/javascript">
		function editProduct(pro) {
			...
			document.getElementById("isDelete").checked = (account[5] == 'true') ? true
					: false;
