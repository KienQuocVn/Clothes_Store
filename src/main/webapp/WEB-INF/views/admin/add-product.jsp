										...
										<form:form modelAttribute="productAdd"
														...
														<span class="file-preview"> <span
															style="position: absolute; inset: 0px; padding-top: 30px;">
																<svg viewBox="0 0 1000 1000">
																	...
																	</svg> <span class="help-text">Tải hình ảnh tại đây</span>
														</span>
														</span>
													</div>
												</div>
											...
											<div class="mb-3 mt-3">
												<label for="exampleInputEmail1" class="form-label">Tên
													sản phẩm <span class="form-text text-danger">*</span>
												</label>
											...
											<div class="mb-3">
												<label for="exampleInputEmail1" class="form-label">Giá
													tiền <span class="form-text text-danger">*</span>
												</label>
											...
											<div class="mb-3">
												<label for="exampleInputEmail1" class="form-label">Số
													lượng <span class="form-text text-danger">*</span>
												</label>
												<form:input id="quantity" path="quantity" type="number"
													min="0" class="form-control" required="required" />
											</div>
											<div class="mb-3">
												<label for="exampleInputEmail1" class="form-label">Loại
											...
											<button type="submit" class="btn btn-primary float-end mb-3">Thêm
												sản phẩm</button>
										</form:form>
									</div>
								</div>
