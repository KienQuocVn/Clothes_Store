...
<body>
						...
						<div
							...
							<div class="page-title d-flex flex-column me-5">
								...
								<ul
									...
									<li class="breadcrumb-item text-dark">Người dùng</li>
								</ul>
							</div>
						</div>
					</div>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5"
										...
										<thead>
											<tr
												...
												<th class="min-w-125px">Vai trò</th>
											...
											<c:forEach items="${accountList}" var="acc">
												<tr>
													...
													<td class="text-end"><a href="#"
														...
														onclick="editUser('${acc.username},${acc.email},${acc.fullname},${acc.password},${acc.activated},${acc.admin}');"
														class="btn btn-warning btn-active-light-primary btn-sm p-1">
															<i class="p-0 bi bi-pencil-square"></i>
													</a> <a href="/admin/user/delete/${acc.username}"
					...
					<form:form action="/admin/user/edit" method="post"
						...
						<div class="mb-3">
							<label for="exampleInputEmail1" class="form-label">Tên
								tài khoản <span class="form-text text-danger">*</span>
							</label>
						...
						<div class="mb-3">
							<label for="exampleInputEmail1" class="form-label">Hình
								ảnh</label> <input id="photoFile" name="image" type="file"
								class="form-control" />
						</div>
	...
	<script type="text/javascript">
		function editUser(acc) {
			...
			document.getElementById("activated").checked = (account[4] == 'true') ? true
					: false;
			document.getElementById("admin").checked = (account[5] == 'true') ? true
					: false;
		}
