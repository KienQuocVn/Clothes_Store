						...
						<div
							...
							<div class="page-title d-flex flex-column me-5">
								...
								<ul
									...
									<li class="breadcrumb-item text-dark">Đơn hàng</li>
								</ul>
							</div>
						</div>
					</div>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5"
										...
										<thead>
											<tr
												...
												<th class="min-w-125px">ID đơn hàng</th>
												<th class="min-w-125px">Người dùng</th>
												<th class="min-w-125px">Ngày tạo</th>
												<th class="min-w-125px">Tộng tiền</th>
											...
											<c:forEach items="${orderList}" var="o">
												<tr>
													...
													<td class="text-end"><a href="#"
														onclick="detail('${o.id}')"
														class="btn btn-secondary btn-active-light-primary btn-sm p-1">
															<i class="p-0 bi bi-three-dots"></i>
													</a></td>
												</tr>
												<tr id="${o.id}detailTitle" class="d-none">
													<td colspan="2">Tên sản phẩm</td>
													<td class="text-end" colspan="2">Số lượng</td>
													<td class="text-end" colspan="2">Giá tiền</td>
												</tr>
